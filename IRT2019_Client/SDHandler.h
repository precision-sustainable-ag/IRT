...
public:
    ...
    void flashLED();
    void write(char filename[], int rep, float battV, tmElements_t & tm, float dataIRT[3][2]);
...
private:
    ...
    void preserve(int rep, float battV, tmElements_t & tm, float dataIRT[3][2]);
