...
public:
    static String makeString(int rep, float battV, tmElements_t & tm, float dataIRT[4][2]) {
...
private:
    ...
    static void makeIRTString(String & str, float dataIRT[4][2]) {
        ...
        for (int numIRT = 3; numIRT >= 0; numIRT--) {
            str.concat( comma );
